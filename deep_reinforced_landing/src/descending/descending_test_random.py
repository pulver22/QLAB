...
def get_random_action():
    ...
    probability = 1.0 / len(action_list)
    probability_descend = probability
...
def main():
    ...
    rospy.init_node("DRLRandomTestNode")
    rospy.loginfo("----- DRL Random Test Node -----")
            ...
            if done:
                ...
                with open("./results_" + str(datetime.date.today().strftime("%m%d%Y")) 
                    ...
                    ground_list = ["asphalt11", "asphalt12", "asphalt13",
                                ...
                                "snow11", "snow12", "snow13",
                                "soil11", "soil12", "soil13"]
                    string_to_add = ground_list[ground_index] + "," + str(episode) + "," + str(step) + "," + str(cumulated_reward) + "," + str(boolean_reward) + '\n'
                    myfile.write(string_to_add)
                    break
