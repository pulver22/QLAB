...
# import roslib
# roslib.load_manifest('deep_reinforced_landing')
# from gazebo_msgs.msg import Light
...
def main():
    ...
    ground_list = ["pavement11", "pavement12", "pavement5",
                   "pavement7", "pavement14", "pavement15", "pavement16"]
